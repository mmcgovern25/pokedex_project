...
car_four = ["https://o.aolcdn.com/images/dims3/GLOB/legacy_thumbnail/1062x597/format/jpg/quality/100/https://s.aolcdn.com/os/ab/_cms/2022/12/12185647/2023-Toyota-Prius-red-front-three-quarter.jpg", "https://bloximages.chicago2.vip.townnews.com/theeagle.com/content/tncms/assets/v3/classifieds/2/09/2093e936-0c42-5029-bddc-c23562d85226/5323f0354b8c3.image.jpg", "https://cars.usnews.com/static/images/Auto/custom/14234/2020_Toyota_Prius_32.jpg"]

car_five = ["https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/1948_Tucker_Torpedo_8511815871.jpg/420px-1948_Tucker_Torpedo_8511815871.jpg", "https://assets.primecreative.com.au/imagegen/cp/black/480/360/s3/cougar-assets/tradeuniquecars/gallerymedia/tucker-48-maroon-8.jpg", "https://assets.primecreative.com.au/imagegen/cp/black/480/360/s3/cougar-assets/tradeuniquecars/gallerymedia/tucker-48-maroon-9.jpg"]

car_six = ["https://di-uploads-pod41.dealerinspire.com/depaulaford/uploads/2020/06/2021-Ford-F-150-Albany-NY-Grey.jpg", "https://techcrunch.com/wp-content/uploads/2021/08/ford-f150-hybrid.jpg?w=1390&crop=1", "https://www.autoo.com.br/fotos/2022/4/960_720/ford2_25042022_71295_960_720.jpg"]

car_photos = [car_one, car_two, car_three, car_four, car_five, car_six]

review_description = ["Very nice car", "Fast and confortable", "GOAT", "Ke", "fr", "seis"]
...
6.times do |i|
  ...
  file4 = URI.open(car_photos[i][3])
  file5 = URI.open(car_photos[i][4])
  file6 = URI.open(car_photos[i][5])
  car.photos.attach([io: file1, filename: "Car#{i} - #{i + 1}.png", content_type: "image/png"], [io: file2, filename: "Car2.png", content_type: "image/png"], [io: file3, filename: "Car3.png", content_type: "image/png"], [io: file4, filename: "Car4.png", content_type: "image/png"], [io: file5, filename: "Car5.png", content_type: "image/png"], [io: file6, filename: "Car6.png", content_type: "image/png"])
  car.save!
end
