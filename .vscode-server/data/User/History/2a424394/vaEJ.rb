...
emails = ["humberto@lewagon.com", "matt@lewagon.com", "ben@lewagon.com", "pedro@lewagon.com", "oi@lewagon.com", "oi2@lewagon.com" ]

names = ["humberto", "matt", "ben", "pedro", "extra", "extra 2", "extra 3"]
...
car_four = ["https://hips.hearstapps.com/hmg-prod/amv-prod-cad-assets/images/01q4/267339/2002-honda-odyssey-photo-9609-s-original.jpg","https://assets.advancedautodealers.com/images/vinventory/vp-24-3668717.jpg","https://i.ytimg.com/vi/FYfyeXiLpiA/maxresdefault.jpg"]

car_photos = [car_one, car_two, car_three, car_four]
...
4.times do |i|
  ...
  car.photos.attach([io: file1, filename: "Car#{i} - #{i + 1}.png", content_type: "image/png"], [io: file2, filename: "Car2.png", content_type: "image/png"], [io: file3, filename: "Car3.png", content_type: "image/png"], [io: file4, filename: "Car4.png", content_type: "image/png"])
  car.save!
end
