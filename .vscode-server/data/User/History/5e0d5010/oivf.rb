...
def restaurants_resources_routes
  ...
  return RoutesSet.draw do
    ...
    gets "restaurants", to: "restaurants#index"
    gets "restaurants", to: "restaurants#new"
    gets "restaurants/:id", to: "restaurants#show"
    gets "restaurants/:id/edit", to: "restaurants#edit"
