...
// sum += addToSum
  ...
  // select tbody
  // add a method that will take the sum of the second td data point
  // TODO: return the sum
};
...
th.forEach((newbackground) => {
  newbackground.style = "background: #DDF4FF";
});
...
const byebye = document.querySelector("label");
byebye.remove();
