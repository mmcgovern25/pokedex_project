...
def times_three(first_num, second_num, third_num)
  first_num * second_num * third_num
end

def divide_two(first_num, second_num)
  first_num / second_num
end

def add_four(first_num, second_num, third_num, fourth_num)
  first_num + second_num + third_num + fourth_num
end

def subtract_two(first_num, second_num)
  first_num - second_num
end

puts times_three(3, 5, 9)
puts divide_two(12, 2)
puts add_four(10, 5, 7, 2)
puts subtract_two(9, 3)
